	...
	public void doGet(HttpServletRequest request,
		...
		if(request.getParameter("do").equals("benutzerAendern")) 
		{
			...
			if(request != null) {
				...
				requestArray[3] = this.aktuellerBenutzer.getSTRAﬂE();
			...
			if(printOut[1].equals("true")) {
				...
				out.print("<h2 style='margin-top:15px; margin-left:15px;'>Benutzer ‰ndern</h2><table class='registrierung'>");
...
String[] validateBenutzer(String[] input) {
	...
	if(!input[3].equals("")) {
		aktuellerBenutzer.setSTRAﬂE(input[3]);
